...
public class Lab4 extends GraphicsLab
{
    ...
    protected void initScene()
    {
        ...
        float globalAmbient[]   = {1.0f,  1.0f,  1.0f, 1f};
...
//        GL11.glNewList(doorList, GL11.GL_COMPILE);
    ...
    {
        // the vertices for the cube (note that all sides have a length of 1)
        Vertex v1 = new Vertex(-0.1f, -0.1f,  0.1f);
        ...
        Vertex v6 = new Vertex(-0.1f,  0.1f, -0.1f);
        Vertex v7 = new Vertex( 0.1f,  0.1f, -0.1f);
        Vertex v8 = new Vertex( 0.1f, -0.1f, -0.1f);
