...
public class Lab5 extends GraphicsLab
{
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
            ...
            float sunEmmisiveON[] = {1.0f, 1.0f, 1.0f, 1.0f};
            
            float sunEmmisiveOFF[] = {0f, 0f, 0f, 0f};
            ...
            GL11.glMaterial(GL11.GL_FRONT, GL11.GL_EMISSION, FloatBuffer.wrap(sunEmmisiveON));
            
            new Sphere().draw(0.5f,10,10);
            
            GL11.glMaterial(GL11.GL_FRONT, GL11.GL_EMISSION, FloatBuffer.wrap(sunEmmisiveOFF));
